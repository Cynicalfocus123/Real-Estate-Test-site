...
export function createApp(dependencies: AppDependencies = {}) {
  ...
  app.use(helmet({ contentSecurityPolicy: { directives: { defaultSrc: ["'self'"], baseUri: ["'self'"], objectSrc: ["'none'"], frameAncestors: ["'self'"], scriptSrc: ["'self'"], imgSrc: ["'self'", "data:", "https:", "blob:"], connectSrc: ["'self'", "https://www.buyhomeforless.com", "https://buyhomeforless.com"] } }, crossOriginResourcePolicy: { policy: "cross-origin" } }));
  app.use(cors({ origin: (origin, callback) => callback(null, !origin || frontendOrigins.has(origin) ? origin ?? false : false), credentials: true, methods: ["GET", "HEAD", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"] }));
